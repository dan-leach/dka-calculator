...
// Bind parameters
$rc = $stmt->bind_param("sssssssssssssssssssssssss", $data->legalAgreement, $data->patientAge, $data->patientSex, $data->protocolStartDatetime, $data->pH, $data->bicarbonate, $data->glucose, $data->ketones, $data->weight, $data->weightLimitOverride, $data->shockPresent, $data->insulinRate, $data->preExistingDiabetes, $data->episodeType, $data->region, $data->centre, $data->ethnicGroup, $preventableFactorsJSON, $auditID, $patientHash, $data->clientDatetime, $data->clientUseragent, $clientIP, $data->appVersion, $calculationsJSON);
