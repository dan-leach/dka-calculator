...
<head>
	...
	<?php include 'php-1.3.4/submitDependencies.php';?>	<!--includes the dependencies required for this page including favicon, bootstrap, javascript files, moment, pdfmake and popovers-->
...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-default">
			...
			<?php include 'php-1.3.4/footer.php';?> <!-- includes the footer file-->
		</div>
	</div>
</body>
</html>