function getDocumentDefinition(inputs, documentVariables){//returns the documentDefinition object
        ...
        content: [ // variables added over top of protocol images, and text for appendicies
            ...
            { //Is patient shocked yes/no indicator box
                canvas: [
                    {
                        type: 'rect',
                        x: documentVariables.xAxisShockIndicator(),
                        y: 332,
                        w: 40,
                        h: 40,
                        lineColor: '#00ff2e',
            ...
            // bolus volumes
            {
                text: documentVariables.bolusVolume(20).toFixed(),
                fontSize: 18,
                absolutePosition: {x: 100, y: 453},
            },
                {
                text: documentVariables.bolusVolume(10).toFixed(),
                fontSize: 18,
                absolutePosition: {x: 100, y: 538},
            },
            {
                text: documentVariables.bolusVolume(10).toFixed(),
                fontSize: 18,
                absolutePosition: {x: 100, y: 592},
            },
            {
                text: documentVariables.bolusVolume(10).toFixed(),
                fontSize: 18,
                ...
                canvas: [
                    {
                        type: 'rect',
                        x: 190,
                        y: documentVariables.yAxisSeverityIndicator(),
                        w: 280,
                        h: 40,
                        lineColor: '#00ff2e',
                        lineWidth: 10
            ...
            {       
                text: documentVariables.deficitPercentage().toFixed(),
                fontSize: 18,
                absolutePosition: {x: 310, y: 280},
            },
            {
                text: documentVariables.deficitVolume().toFixed(),
                fontSize: 18,
            ...
            {
                text: documentVariables.bolusVolumeToSubtract().toFixed(),
                fontSize: 18,
                absolutePosition: {x: 300, y: 390},
            },
            {
                text: documentVariables.deficitVolumeLessBolus().toFixed(),
                fontSize: 18,
            ...
            {
                text: documentVariables.deficitRate().toFixed(1),
                fontSize: 18,
                absolutePosition: {x: 430, y: 470},
            },
            //maintenance rate = 
            {
                text: documentVariables.maintenanceVolume().toFixed(),
                fontSize: 18,
                absolutePosition: {x: 185, y: 565},
            },
            {
                text: documentVariables.maintenanceRate().toFixed(1),
                fontSize: 18,
            ...
            {
                text: documentVariables.fluidRate().toFixed(1),
                fontSize: 18,
            ...
            { //Patient has pre-existing diabetes yes/no indicator box
                canvas: [
                    {
                        type: 'rect',
                        x: documentVariables.xAxisDiabeticIndicator(),
                        y: 400,
                        w: 40,
                        h: 40,
                        lineColor: '#00ff2e',
            ...
            {
                text: documentVariables.insulinRate().toFixed(2),
                fontSize: 18,
            ...
            {
                text: documentVariables.timingTime(0),
                style: 'timing',
                absolutePosition: {x: 107, y: 86},
            },
            {
                text: documentVariables.timingDate(0),
                style: 'timing',
                absolutePosition: {x: 97, y: 93},
            },
            {
                text: documentVariables.timingTime(2),
                style: 'timing',
                absolutePosition: {x: 107, y: 105},
            },
            {
                text: documentVariables.timingDate(2),
                style: 'timing',
                absolutePosition: {x: 97, y: 112},
            },
            {
                text: documentVariables.timingTime(6),
                style: 'timing',
                absolutePosition: {x: 107, y: 143},
            },
            {
                text: documentVariables.timingDate(6),
                style: 'timing',
                absolutePosition: {x: 97, y: 150},
            },
            {
                text: documentVariables.timingTime(10),
                style: 'timing',
                absolutePosition: {x: 107, y: 181},
            },
            {
                text: documentVariables.timingDate(10),
                style: 'timing',
                absolutePosition: {x: 97, y: 188},
            },
            {
                text: documentVariables.timingTime(14),
                style: 'timing',
                absolutePosition: {x: 107, y: 219},
            },
            {
                text: documentVariables.timingDate(14),
                style: 'timing',
                absolutePosition: {x: 97, y: 226},
            },
            {
                text: documentVariables.timingTime(18),
                style: 'timing',
                absolutePosition: {x: 107, y: 256},
            },
            {
                text: documentVariables.timingDate(18),
                style: 'timing',
                absolutePosition: {x: 97, y: 263},
            },
            {
                text: documentVariables.timingTime(22),
                style: 'timing',
                absolutePosition: {x: 107, y: 294},
            },
            {
                text: documentVariables.timingDate(22),
                style: 'timing',
                absolutePosition: {x: 97, y: 301},
            },
            {
                text: documentVariables.timingTime(26),
                style: 'timing',
                absolutePosition: {x: 107, y: 332},
            },
            {
                text: documentVariables.timingDate(26),
                style: 'timing',
                absolutePosition: {x: 97, y: 339},
            },
            {
                text: documentVariables.timingTime(30),
                style: 'timing',
                absolutePosition: {x: 107, y: 370},
            },
            {
                text: documentVariables.timingDate(30),
                style: 'timing',
                absolutePosition: {x: 97, y: 377},
            },
            {
                text: documentVariables.timingTime(34),
                style: 'timing',
                absolutePosition: {x: 107, y: 407},
            },
            {
                text: documentVariables.timingDate(34),
                style: 'timing',
                absolutePosition: {x: 97, y: 414},
            },
            {
                text: documentVariables.timingTime(38),
                style: 'timing',
                absolutePosition: {x: 107, y: 445},
            },
            {
                text: documentVariables.timingDate(38),
                style: 'timing',
                absolutePosition: {x: 97, y: 452},
            },
            {
                text: documentVariables.timingTime(42),
                style: 'timing',
                absolutePosition: {x: 107, y: 482},
            },
            {
                text: documentVariables.timingDate(42),
                style: 'timing',
            ...
            { //outer table adds 20px border for whole page
                ...
                body: [
                    ...
                    [ '', '      1. Remove 100mL from a bag of Sodium Chloride 0.9% with 20mmol Potassium Chloride in 500mL', '' ],
                    [ '', '      2. Draw up 100mL of Glucose 50% using a syringe and add to the above bag to make the glucose concentration 10% ', '' ],
                    [ '', '      3. Mix well before administration', '' ],
                    [ '', ' ', '' ],
