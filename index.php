...
<body>
	...
	<div class="container">
		...
		<form> <!--This first form contains confidential information that is not submitted to the server-->
			...
			<div class="panel panel-warning"> <!--panel for update notes - remove in April 2022-->
				...
				<div class="panel-body">
				    <div class="row">
						<div class="col-sm-12">
						    <p>These updates are in response to <a href="https://www.bsped.org.uk/clinical-resources/guidelines/#diabetes" target="_blank"> the 2021 update to the BSPED Guideline for the Management of Children and Young People under the age of 18 years with Diabetic Ketoacidosis</a>.</p>
							<ul>
							...
							<p><a href="https://github.com/dan-leach/dka-calculator/blob/master/changelog.md" target="_blank">View the full changelog on GitHub.</a></p>
		...
		<form id="protocolForm" method="post" action="submit-v1.2.php"> <!--This second form contains the non-confidential information that IS submitted to the server and logged-->
					...
					<div class="row"> <!--episode type-->
						<div class="col-sm-7">
							<div id="div_episode" class="input-group has-feedback">
								...
								<div class="form-group">
								  <select class="form-control" autocomplete="off" id="episode" name="episode" onchange="checkProgress('episode')">
			...
			<div class="row">
				<div class="col-sm-6 col-md-offset-3">
					<button type="button" id="testfill" class="btn btn-primary btn-block">Joe Bloggs</button>
				</div>
			</div>
			-->
