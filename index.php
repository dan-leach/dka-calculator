...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<?php include 'php-1.3.2/indexDependencies.php';?> <!--includes the dependencies required for this page including favicon, bootstrap, javascript file, moment, date/time picker, popover and unique ID generator-->
	<?php include 'php-1.3.2/loader.php';?> <!--includes the loader which displays until page is ready-->
</head>
<body>
	<div class="loader"></div> <!--this div required for php/loader.php to work-->
	<div class="container">
		<?php include 'php-1.3.2/jumbotron.php';?> <!--includes the header-->
		<form> <!--This first form contains confidential information that is not submitted to the server-->
			...
			<div class="panel panel-default"> <!--panel for advisory notes-->
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-12">
							<p>Complete the form below. You can hover over the icons (e.g. <a href="#" tabindex="-1" data-toggle="tooltip" title=""><i class="glyphicon glyphicon-user"></i></a> at the left of each input box for more guidance. Once each input is completed successfully it will be highlighted in green. After you press submit, if there is a problem with an entry, it will be highlighted in red and an explanatory note will appear to the right.<br>
							<br>
							For information about how the data is used, hover over the <a href="#" tabindex="-1" data-toggle="tooltip" title="" data-content=""><span class="glyphicon glyphicon-info-sign"></span></a> for that section. Once the form is complete click the submit button. The generated protocol will be ready to download within a few seconds. If you encounter problems, a backup version of the ICP (without pre-filled calculations) can be downloaded from <a href="https://dka-calculator.co.uk/DKA-ICP-2021.pdf" tabindex="-1" title="Backup ICP."> here.</a></p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row"> <!--name-->
						<div class="col-sm-7">
							<div id="div_name" class="input-group has-feedback">
								...
								<input id="name" type="text" autocomplete="off" class="form-control" name="name" maxlength="30" onBlur="indexForm.inputs.name.blur()"/> <!--the input field itself, calls check function when focus leaves the input field-->
					...
					<div class="row"> <!--Weight-->
						<div class="col-sm-7">
							<div id="div_weight" class="input-group has-feedback">
								...
								<input id="weight" type="number" autocomplete="off" class="form-control" name="weight" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="5" onBlur="indexForm.inputs.weight.blur()">
					...
					<div class="row"> <!--pH-->
						<div class="col-sm-7">
							<div id="div_pH" class="input-group has-feedback">
								...
								<input id="pH" type="number" autocomplete="off" class="form-control" name="pH" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="4" onBlur="indexForm.inputs.pH.blur()" step="0.01" min=6.5 max=7.4>
		...
		<br>
		<?php include 'php-1.3.2/footer.php';?> <!--includes footer file-->
	</div>
</body>
</html>